...
const addTabContent = ($currentTabBtn, $currentTabPanel)=>{
    ...
    fetchData([['mealType', $currentTabBtn.textContent.trim().toLowerCase()], ...cardQueries], function(data){
        ...
        for(let i=0; i<12; i++){
            ...
            const firstIndex= href.indexOf("v2/")+3;
            const lastIndex= href.indexOf("?type=");
            
            const /** {String} */ recipeId = href.slice(firstIndex, lastIndex);
          ...
          <div class="card-body">
            ...
            <div class="meta-wrapper">
              ...
              <button class="icon-btn has-state ${isSaved ? "saved" : "removed"}" aria-label="Add to saved recipes" onclick="savedRecipe(this, '${recipeId}')">
